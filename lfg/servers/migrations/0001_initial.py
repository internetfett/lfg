...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ServerType'
        db.create_table('servers_servertype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Game'])),
        ))
        db.send_create_signal('servers', ['ServerType'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ServerType'
        db.delete_table('servers_servertype')
